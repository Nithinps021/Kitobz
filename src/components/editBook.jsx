...
// Redux imports
import { updateBook, addimg } from "../Redux/actions/dataActions";
...
class EditBook extends Component {
  constructor(props) {
    super(props);
    this.state = {
      bookname: this.props.details.bookname,
      price: this.props.details.price,
      forsem: this.props.details.forsem,
      branch: this.props.details.branch,
  ...
  handleSubmit = () => {
    const bookData = {
      bookId: this.props.details.bookId,
      bookname: this.state.bookname,
      branch: this.state.branch,
      forsem: this.state.forsem,
      status: this.state.status,
      price: this.state.price,
      phoneNo: this.props.user.userDetails.phoneNo,
      imgURL: this.props.bookstatus.imgURL || this.props.details.imgURL,
    };
    ...
    return (
      <Fragment>
        ...
        >
          ...
          <DialogTitle className={classes.form}>Edit Book Details</DialogTitle>
          <DialogContent>
            <form>
...
const mapActionToProp = { updateBook, addimg };

export default connect(
  mapStateToProp,
  mapActionToProp
)(withStyles(style)(EditBook));
